...
public:
    Tile2D(size_t _pos_x, size_t _pos_y, size_t _size_x, size_t _size_y, int _type);
    ...
    void set_size(size_t _size_x, size_t _size_y);
...
public:
    ...
    void set_tile_size(size_t _size_x, size_t _size_y);
